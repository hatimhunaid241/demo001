        ...
        <div className="max-w-350 mx-auto">
          <div className="max-w-3xl mx-auto px-8 md:px-12 lg:px-16 xl:px-20 py-20 lg:py-28">
            ...
            <FadeInUp delay={0.68} className="mt-4">
              <Image src="/otherImages/David 01 Website.jpg" alt="David de Jong — chess designer and artist behind Royal Chess Design" width={800} height={600} className="w-full h-auto object-cover rounded-lg shadow-lg" />
            </FadeInUp>
