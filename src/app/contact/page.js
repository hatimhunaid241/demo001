      ...
      >
        <div className="text-center px-6">
          ...
          <motion.div
            ...
            className="h-[1px] bg-gradient-to-r from-transparent via-gold to-transparent mx-auto"
          />
        </div>
      </HeroSection>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-28">
            ...
            <div>
              ...
              <FadeInUp delay={0.2}>
                <p className="font-[family-name:var(--font-cormorant)] text-base md:text-lg leading-relaxed text-text-secondary font-light mb-12">
              ...
              <div className="space-y-10">
                <FadeInUp delay={0.3}>
                  <div>
                    <h4 className="font-[family-name:var(--font-playfair)] text-[11px] tracking-[0.3em] text-gold uppercase mb-4">
                      ADDRESS
                    </h4>
                    <p className="font-[family-name:var(--font-cormorant)] text-base text-text-secondary font-light leading-relaxed">
                      42 King&apos;s Road<br />
                ...
                <FadeInUp delay={0.35}>
                  <div>
                    ...
                    <a
                      ...
                      className="font-[family-name:var(--font-cormorant)] text-base text-text-secondary font-light hover:text-gold transition-colors duration-300"
                    >
              ...
              {submitted ? (
                <FadeIn>
                  <div className="text-center py-16">
                    ...
                    <h3 className="font-[family-name:var(--font-playfair)] text-2xl tracking-[0.1em] text-charcoal mb-4">
                      Thank You
                    </h3>
                    <p className="font-[family-name:var(--font-cormorant)] text-lg text-text-secondary font-light mb-8">
                ...
                <FadeInUp delay={0.2}>
                  <form onSubmit={handleSubmit} className="space-y-8">
                    <div>
                      <label className="font-[family-name:var(--font-cormorant)] text-[11px] tracking-[0.3em] text-text-muted uppercase block mb-3">
                        NAME *
                      </label>
                      <input
                        type="text"
                        ...
                        required
                        className="w-full bg-transparent border-b border-medium-gray pb-3 text-charcoal font-[family-name:var(--font-cormorant)] text-base focus:border-gold transition-colors duration-300 placeholder:text-text-muted/40"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={5}
                        className="w-full bg-transparent border-b border-medium-gray pb-3 text-charcoal font-[family-name:var(--font-cormorant)] text-base focus:border-gold transition-colors duration-300 resize-none placeholder:text-text-muted/40"
      ...
      <section className="py-20 md:py-28 bg-white border-t border-medium-gray">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
          <FadeInUp className="text-center mb-16">
            ...
            <h2 className="font-[family-name:var(--font-playfair)] text-2xl md:text-3xl font-normal tracking-[0.1em] text-charcoal">
              Our Presence
            </h2>
          </FadeInUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 text-center">
            <FadeInUp delay={0.1}>
              <div>
                ...
                <h3 className="font-[family-name:var(--font-playfair)] text-lg tracking-[0.15em] text-charcoal mb-3">
                  LONDON
                </h3>
                <p className="font-[family-name:var(--font-cormorant)] text-sm text-text-secondary font-light leading-relaxed">
                  42 King&apos;s Road<br />
                  Chelsea, SW3 4UD<br />
                  +44 (0) 20 1234 5678
                </p>
