...
export const chessSets = [
  /* ═══════════════════════════════════════════════════════
     SET I — Royal Majestic Gold Chess Set
  ═══════════════════════════════════════════════════════ */
  {
    id: "royal-majestic-gold",
    name: "Royal Majestic Gold Chess Set",
    subtitle: "18 Karat Gold, Rutilated Quartz & Precious Gemstones",
    description:
    ...
    detail: {
      ...
      pieces: [
        ...
        },
        {
          ...
          quote: {
            text: "The great thing about chess is it's a game for oneself. You don't work on what you can't control, you just work on yourself.",
        ...
        },
        {
          ...
          quote: {
            ...
            author: "Not attributed to a single source",
          },
        },
      ],
      table: {
        ...
        specs: [
          { label: "Table Length", value: "2.5 meters" },
          { label: "Table Height", value: "80 cm" },
          { label: "Board Dimensions", value: "50 × 50 cm" },
          { label: "Table Material", value: "Green Marble" },
          { label: "Board Material", value: "Rock Crystal & Smoky Quartz" },
          { label: "Lighting", value: "Integrated beneath board" },
        ],
        quote: {
          text: "Chess is rarely a game of ideal moves. Almost always, a player faces a series of difficult consequences whichever move he makes.",
          author: "David Shen",
        },
      },
    },
  ...
  /* ═══════════════════════════════════════════════════════
     SET II — Royal Silver Chess Set
  ═══════════════════════════════════════════════════════ */
  {
    id: "royal-silver",
    name: "Royal Silver Chess Set",
    subtitle: "925 Sterling Silver, Moissanite & Natural Quartz",
    description:
    ...
    detail: {
      setNumber: "II",
      overview:
        "This set features the classic and highly-regarded Staunton design, a style officially recommended for FIDE competitions. Each piece is meticulously cast in solid 925 sterling silver, a precious metal chosen for its brilliant luster and lasting quality. The result is a collection of silver chessmen that are both elegant in form and satisfyingly substantial in weight.\n\nThe chessboard is a masterpiece of natural stone and craftsmanship. It is expertly created using contrasting squares of polished rock crystal and smoky quartz. The cool, translucent beauty of the rock crystal provides a striking contrast to the rich, earthy tones of the smoky quartz, creating a playing surface that is both visually stunning and naturally unique.\n\nThis Royal Silver Chess Set offers a game of refined elegance. The familiar lines of the Staunton design, combined with the luxurious feel of genuine silver and natural quartz, create an unparalleled playing experience. The set is not merely a game, but a timeless work of art, destined to be a centerpiece in any collection.",
      overviewQuote: {
        text: "With talent, study and a positive attitude, there is no limit to how far you can go.",
        author: "Bobby Fisher",
      },
      pieces: [
        {
      ...
      table: {
        ...
        specs: [
          { label: "Table Material", value: "African Wengé Wood" },
          { label: "Surface Dimensions", value: "500 × 500 mm" },
          { label: "Table Height", value: "800 mm" },
          { label: "Board Dimensions", value: "470 × 470 mm" },
          { label: "Board Height", value: "10 mm" },
          { label: "Feature", value: "Hidden bar with crystal glasses & wheels" },
        ],
        quote: {
  ...
  /* ═══════════════════════════════════════════════════════
     SET III — Royal Gold Petite Chess Set (New Classic)
  ═══════════════════════════════════════════════════════ */
  {
    ...
    detail: {
      setNumber: "III",
      overview:
        "This is an embodiment of contrast and elegance. The opposing armies, rendered in solid 18 karat yellow and white gold for the adversary, are a modern interpretation of the classic Staunton design, ensuring both playability and visual appeal. This exquisite game is played on a transparent, custom-molded epoxy resin board. The glossy, glass-like surface, with a substantial height of 100mm, showcases the beauty of the gold pieces and creates a stunning visual depth, making every game a truly luxurious experience.",
      overviewQuote: {
        text: "If revenge motivates you, go for it! But the main thing is to set your game in order.",
      ...
      pieces: [
        {
          ...
          quote: {
            text: "When you see a good move, always look for a better one.",
        ...
        },
        {
          ...
          quote: {
            text: "Definitely, some of the artistry and poetry has been lost in modern chess. It's very rare that I play a game where I'm like, 'Wow, this is really interesting.'",
      ...
      table: {
        ...
        specs: [
          { label: "Table Material", value: "Durable Maple Wood" },
          { label: "Table Dimensions", value: "320 × 320 mm (square)" },
          { label: "Table Height", value: "135 mm" },
          { label: "Board Material", value: "Crystal Glass in Hard Epoxy Resin" },
          { label: "Board Height", value: "100 mm" },
          { label: "Squares", value: "64 crystal glass elongated pyramids" },
        ],
        quote: {
          text: "Move in silence only speak when it's time to say checkmate.",
          author: "Lorenzo Senni",
        },
      },
    },
  },
  ...
  /* ═══════════════════════════════════════════════════════
     SET IV — Royal Gold Petite Chess Set (Geometric)
  ═══════════════════════════════════════════════════════ */
  {
    ...
    detail: {
      setNumber: "IV",
      overview:
        "The set features miniature Staunton-style pieces, a design recognized by the FIDE for its timeless elegance and playability. Meticulously crafted from solid 18 karat yellow and white gold, these pieces exude a luxurious finish. The duality of the precious metals creates a striking contrast, making each king, queen, bishop, knight, rook and pawn a miniature work of art.\n\nThe geometric board is a modern marvel, composed of perfectly square, faceted crystal glass cubes. This precision-cut design captures and reflects light, creating a stunning visual display. Look deeper, and you'll discover a unique, laser-engraved detail within each crystal cube: a miniature 3D galaxy star. This captivating detail adds a mesmerizing depth and a touch of the cosmos to every game.\n\nThis set is more than a game; it's a statement piece. It combines the familiar, classic lines of the Staunton style with a breathtakingly modern and elegant table design. The luxurious weight of the gold pieces and the ethereal, sparkling surface of the crystal board create a tactile and visual experience unlike any other.",
      overviewQuote: {
        text: "A chess game in progress is… a cosmos unto itself, fully insulated from an infant's cry, an erotic invitation, or war.",
        author: "David Shenk",
      },
      pieces: [
        {
        ...
        },
        {
          ...
          quote: {
            text: "There would be no game of chess if the pawn refused to play.",
            author: "Orrin Hudson",
          },
        },
      ],
      table: {
        ...
        specs: [
          { label: "Table Material", value: "Durable Maple Wood" },
          { label: "Table Surface", value: "240 × 240 mm" },
          { label: "Table Height", value: "580 mm" },
          { label: "Crystal Board", value: "240 × 240 mm" },
          { label: "Board Thickness", value: "25 mm" },
          { label: "Design Feature", value: "Beam-like infinity design" },
        ],
        quote: {
  ...
  /* ═══════════════════════════════════════════════════════
     SET V — Royal Crystal Glass Chess Set
  ═══════════════════════════════════════════════════════ */
  {
    id: "royal-crystal-glass",
    name: "Royal Crystal Glass Chess Set",
    subtitle: "3D Laser-Etched Crystal with Gold & Silver Finishes",
    description:
    ...
    detail: {
      setNumber: "V",
      overview:
        "This is a triumph of modern artistry, combining the timeless strategy of chess with the breathtaking beauty of fine craftsmanship. Instead of traditional carving, each piece is a flawless crystal cube, meticulously engraved with a stunning 3D laser-etched rendition of its corresponding chess figure. The effect is a captivating optical illusion, with the pieces appearing to float suspended within their crystalline forms.\n\nTo distinguish the opposing armies, the top of each piece is carefully finished with a precious metal coating. One side is rendered in gleaming gold, while the opposing side is finished in brilliant silver, ensuring a clear distinction and adding a final touch of luxury. The combination of pure crystal and precious metals creates a set that is not merely a game, but a sculptural work of art.\n\nThe pieces are substantial in hand and precisely crafted to ensure balanced and pleasing gameplay.",
      overviewQuote: {
